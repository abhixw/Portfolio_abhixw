...
export default function Navbar() {
    ...
    return (
        <nav
            className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-5xl rounded-2xl border border-cyan-500/20 bg-gradient-to-r from-cyan-500/10 via-emerald-500/5 to-cyan-500/10 dark:from-cyan-500/20 dark:via-emerald-500/15 dark:to-cyan-500/20 backdrop-blur-2xl shadow-[0_8px_32px_rgba(6,182,212,0.15)] transition-all duration-500 hover:scale-[1.01] hover:bg-white/10"
        >
