  ...
  const cases = [
    {
      idx: "01",
      title: "Recruvoskill",
      tagline: "AI-Native Hiring Platform · 2026",
      description: "An AI-native hiring platform using GitHub, Codeforces, and LeetCode evidence for outcome-based candidate evaluation. Built deterministic task-based scoring with LLM-powered task decomposition, signal extraction, and explainable candidate feedback — with JWT authentication, GitHub-verified identity, role-based access, SEO job pages, audit logging, and recruiter-controlled decisions.",
      chips: ["FastAPI", "React", "MongoDB", "Groq", "Docker", "GitHub API"],
      link: "https://github.com/abhixw/Recruvoskill",
      stamp: "AI ASSESSMENT\nSCORING DASHBOARD"
    },
    {
      idx: "02",
      ...
      link: "https://github.com/abhixw/Hirova",
      stamp: "AI PROCTORING\nASYNC PIPELINE"
    },
    {
      idx: "03",
